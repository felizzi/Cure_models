...
for (i in 1:length(models)){
  png(paste("reports/plot_models_",models[i],"_coBRIM.png",sep = ""), width = 9, height = 6, units="in", res=500)
  ...
  write.csv(fits_f1, file= paste("reports/input_cures_AIC_coBRIM.csv",sep = ""))
